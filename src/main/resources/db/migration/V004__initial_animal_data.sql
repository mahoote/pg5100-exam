...
insert into animals
values (nextval('animals_id_seq'), 12345, 'Fido', 7, 1, 'Sport and healthy.', now()),
       (nextval('animals_id_seq'), 56789, 'Happy', 2, 2, 'Flies like a champ.', now()),
       (nextval('animals_id_seq'), 24681, 'Smaug', 12, 3, 'Old and wise, but likes to stay active.', now());